...
def freeze_model(score_threshold):
    ...
    model = get_yolo_client(ues_tiny, train_parameters['class_dim'], yolo_config['anchors'], yolo_config['anchor_mask'])
    ...
    #fluid.io.save_inference_model(train_parameters['freeze_split_dir'], ['image1','image2','image3'], pred, exe, freeze_program,model_filename='__model1__', params_filename='__params1__')
    fluid.io.save_inference_model(train_parameters['freeze_split_dir'], ['image'], outputs, exe, freeze_program,model_filename='__model__', params_filename='__params__')
